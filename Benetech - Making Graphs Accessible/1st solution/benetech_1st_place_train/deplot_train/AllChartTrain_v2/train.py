...
### Model configuration
config = Pix2StructConfig.from_pretrained("google/deplot")
...
class DonutModelPLModule(pl.LightningModule):
    ...
    def configure_optimizers(self) -> torch.optim.Optimizer:
        ...
        scheduler = get_cosine_schedule_with_warmup(optimizer, num_warmup_steps=4000, num_training_steps=int(len(train_df)//CFG.batch_size) * CFG.epochs)
...
model = Pix2StructForConditionalGeneration.from_pretrained("google/deplot", config=config)
